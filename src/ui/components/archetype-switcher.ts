...
const CATEGORY_ORDER = ['Attractor', 'Map', 'Fractal', 'Surface', 'Spacetime', 'Volume', 'Conformal', 'Kaleidoscope', 'Linework', 'Bloom', 'Parametric', 'Life', 'Fluid', 'Field', 'Oscillator', 'Billiard', 'Matter', 'Sampler', 'Orbital', 'Spectral', 'N-Body', 'Cosmology', 'Plasma', 'Atmosphere', 'Tiling', 'Number', 'Neural', 'Custom'];
