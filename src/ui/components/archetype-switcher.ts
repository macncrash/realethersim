...
const CATEGORY_ORDER = ['Attractor', 'Map', 'Fractal', 'Surface', 'Spacetime', 'Volume', 'Conformal', 'Kaleidoscope', 'Parametric', 'Life', 'Fluid', 'Field', 'Oscillator', 'Billiard', 'Matter', 'Sampler', 'Orbital', 'N-Body'];
