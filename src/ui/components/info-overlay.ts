...
const CATEGORY_ORDER = [
  ...
  'Parametric', 'Life', 'Fluid', 'Field', 'Oscillator', 'Billiard', 'Matter', 'Sampler', 'Orbital', 'Spectral', 'N-Body', 'Cosmology', 'Plasma', 'Atmosphere', 'Tiling', 'Number', 'Neural', 'Network', 'Custom',
];
